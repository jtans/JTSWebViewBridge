...
#import <JTSWebViewBridge/UIWebView+JTSBridge.h>
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [webView injectHandlers];
    
    _bridge = [webView bridge];
...
- (void)callHandler:(id)sender {
    ...
    [_bridge callHandler:@"greetingFromObjC" data:data responseCallback:^(id response) {
        NSLog(@"greetingFromObjC responded: %@", response);
    }];
}
